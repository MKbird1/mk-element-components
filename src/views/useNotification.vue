<template>
  <div>
    <div class="demo">
      <mk-notification class="demo" :value="50"></mk-notification>
    </div>
    <div class="demo">
      <mk-notification class="demo" :value="50" :max="30"></mk-notification>
    </div>
    <div class="demo">
      <mk-notification class="demo" :value="50" isDot></mk-notification>
    </div>
    <div class="demo">
      <mk-notification
        class="demo"
        icon="el-icon-chatround"
        :value="50"
      ></mk-notification>
    </div>
